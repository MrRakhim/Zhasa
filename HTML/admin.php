...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light" style="width: 100%; justify-content: space-between; display: flex;">
	  ...
	  <h2 class="navbar-brand" style="width: 50%; text-align: center;">Welcome <?php echo $row -> firstname; ?>, you're on Admin Page</h2>
	  <?php 
	  	}}
	  ?>
	...
	<div class="limiter_admin" style="width: 80%; margin: 0 auto;">
		<h3 style="text-align: center; margin: 20px auto;">Upload new blogs to newsletter <span class="badge badge-secondary">New</span></h3>
		<form action="blogs/save.php" method="post" enctype="multipart/form-data" style="margin: 20px auto">

			<div class="input-group mb-3">
				  <input type="text" name="title" class="form-control" placeholder="Enter the title" aria-label="Username" aria-describedby="basic-addon1">
			</div>
			<div class="input-group mb-3">
		...
		<div class="card-deck">
				...
				<div class="card">
				    ...
				    <div class="card-body">
				      ...
				      <a href="blogs/delete.php?id=<?php echo $row -> id;?>">Delete</a>
					  <a href="blogs/update.php?id=<?php echo $row-> id;?>">Edit</a>
				    </div>
				</div>
				<?php
					}
